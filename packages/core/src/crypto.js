 ...
 */
export function decryptApiKey(encryptedValue, secret) {
 ...
 * @returns Masked key
 */
export function maskEncryptedApiKey(encryptedKey, secret) {
 ...
 */
export function encryptSettingValue(key, value, secret) {
    const sensitiveKeys = [
        'api_key',
        'apikey',
        'anthropic_api_key',
 ...
 */
export function decryptSettingValue(key, value, secret) {
    const sensitiveKeys = [
        'api_key',
        'apikey',
        'anthropic_api_key',
